...
public import CoAes.Builder.Constructors
public import CoAes.Builder.NormSimp
public import CoAes.Builder.Tactic
public import CoAes.Builder.Apply
...
where
  err (ruleType : String) : RuleBuilder := λ input =>
    throwError m!"coaes: Unable to interpret '{input.term}' as {ruleType} rule. Try specifying a builder."
