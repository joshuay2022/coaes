...
public import CoAes.RuleTac.FVarIdSubst
...
/--
A representation of the differences between two goals. Each CoAes rule produces
...
information about CoAes goals and for which it is more efficient to update the
