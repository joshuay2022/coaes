...
import CoAes.Util.Basic
import CoAes.Util.EqualUpToIds
import CoAes.Tree.RunMetaM

-- Some simple test cases for the EqualUpToIds module. The module is mostly
-- tested by using it in script validation, which is run on almost all CoAes
-- calls in the test suite.

open CoAes Lean Lean.Elab.Tactic
