...
add_coaes_rules safe [BigStep.skip, BigStep.assign, BigStep.seq, BigStep.while_false]
add_coaes_rules 50% [apply BigStep.while_true]
add_coaes_rules safe [
