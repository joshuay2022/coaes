...
attribute [coaes unsafe] EvenOrOdd.even EvenOrOdd.odd
attribute [coaes safe] Even.zero Even.plus_two
attribute [coaes 100%] Odd.one Odd.plus_two
...
example : 0 = 0 := by coaes


-- An intentionally looping CoAes call, to test the limiting options
section Loop
...
/--
error: tactic 'coaes' failed, maximum number of rule applications (20) reached. Set the 'maxRuleApplications' option to increase the limit.
-/
#guard_msgs in
...
/--
error: tactic 'coaes' failed, maximum number of goals (20) reached. Set the 'maxGoals' option to increase the limit.
-/
#guard_msgs in
example (h : α → α) (h' : Wrap α) : α := by
  coaes (add safe h)
...
/--
error: tactic 'coaes' failed, failed to prove the goal. Some goals were not explored because the maximum rule application depth (20) was reached. Set option 'maxRuleApplicationDepth' to increase the limit.
-/
#guard_msgs in
example (h : α → α) (h' : Wrap α) : α := by
  coaes (add safe h)
